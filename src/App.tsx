      ...
      <main className="relative z-10">
        ...
        <section id="proof" className="bg-white border-b-4 border-black">
          <div className="max-w-7xl mx-auto px-6 py-24">
            ...
            <div className="reveal grid grid-cols-2 md:grid-cols-4 gap-0 border-4 border-black mb-16 mt-8 shadow-[8px_8px_0px_#000] rounded-2xl overflow-hidden">
              {[
                ...
                <div key={s.lbl} className="p-5 md:p-6 relative group overflow-hidden border-r-4 border-black last:border-r-0 transition-colors duration-300"
        ...
        {/* WHY ME (Parallax) */}
        <section id="whyme" className="relative pb-20 md:pb-32">
          <div className="parallax-panel bg-[#FACC15] border-4 border-black flex items-center p-[clamp(40px,8vw,100px)_clamp(24px,6vw,80px)] overflow-hidden z-[11] mb-4 md:mb-0"
            style={{ top: '80px' }}>
            <div className="absolute -right-5 -bottom-10 text-[260px] font-black opacity-5 leading-none pointer-events-none">01</div>
            <div className="absolute top-0 left-[clamp(24px,6vw,80px)] w-[3px] h-full bg-black/10" />
            <div className="max-w-[640px] relative z-10">
              <div className="font-black text-xs uppercase tracking-widest mb-4 opacity-40">01 / Differentiator</div>
              <h2 className="font-black uppercase tracking-tighter leading-[0.9] mb-6 text-[clamp(48px,8vw,96px)] text-[#111] drop-shadow-[2px_2px_0px_rgba(255,255,255,0.5)]">
                Founder-Level<br />Thinking.
              </h2>
              <p className="font-bold leading-relaxed mb-8 text-[clamp(16px,2vw,20px)] text-[#111] max-w-[500px] bg-white/40 backdrop-blur-md p-6 rounded-xl border border-white/20">
              ...
              <div className="flex flex-wrap gap-2.5">
                {['P&L Awareness', 'Margin-First Scaling', 'Business Sense > Vanity'].map(t => (
                  <span key={t} className="bg-[#111] text-white border-[3px] border-black px-3.5 py-1.5 text-xs font-bold uppercase tracking-widest rounded shadow-[3px_3px_0_rgba(0,0,0,.2)]">
                    {t}
                  </span>
                ))}
              </div>
          ...
          <div className="parallax-panel bg-[#1D4ED8] text-white border-4 border-black flex items-center p-[clamp(40px,8vw,100px)_clamp(24px,6vw,80px)] overflow-hidden z-[12] mb-4 md:mb-0"
            style={{ top: '120px' }}>
            <div className="absolute -right-5 -bottom-10 text-[260px] font-black opacity-10 leading-none pointer-events-none">02</div>
            <div className="absolute top-0 left-[clamp(24px,6vw,80px)] w-[3px] h-full bg-white/10" />
            <div className="max-w-[640px] relative z-10">
              <div className="font-black text-xs uppercase tracking-widest mb-4 opacity-40">02 / Differentiator</div>
              <h2 className="font-black uppercase tracking-tighter leading-[0.9] mb-6 text-[clamp(48px,8vw,96px)] drop-shadow-[4px_4px_0_rgba(0,0,0,0.4)]">
                Testing<br />At Scale.
              </h2>
              <p className="font-bold leading-relaxed mb-8 text-[clamp(16px,2vw,20px)] text-white max-w-[500px] bg-black/40 backdrop-blur-md p-6 rounded-xl border border-white/10">
              ...
              <div className="flex flex-wrap gap-2.5">
                {['High-Velocity Testing', 'Creative Iterations', 'Data-Driven Kill Switches'].map(t => (
                  <span key={t} className="bg-white/15 text-white border-2 border-white/30 px-3.5 py-1.5 text-xs font-bold uppercase tracking-widest rounded">
                    {t}
                  </span>
                ))}
              </div>
          ...
          <div className="parallax-panel bg-[#EF4444] text-white border-4 border-black flex items-center p-[clamp(40px,8vw,100px)_clamp(24px,6vw,80px)] overflow-hidden z-[13] mb-4 md:mb-0"
            style={{ top: '160px' }}>
            <div className="absolute -right-5 -bottom-10 text-[260px] font-black opacity-10 leading-none pointer-events-none">03</div>
            <div className="absolute top-0 left-[clamp(24px,6vw,80px)] w-[3px] h-full bg-white/10" />
            <div className="max-w-[640px] relative z-10">
              <div className="font-black text-xs uppercase tracking-widest mb-4 opacity-40">03 / Differentiator</div>
              <h2 className="font-black uppercase tracking-tighter leading-[0.9] mb-6 text-[clamp(48px,8vw,96px)] drop-shadow-[4px_4px_0_rgba(0,0,0,0.4)]">
                Revenue<br />Obsessed.
              </h2>
              <p className="font-bold leading-relaxed mb-8 text-[clamp(16px,2vw,20px)] text-white max-w-[500px] bg-black/40 backdrop-blur-md p-6 rounded-xl border border-white/10">
              ...
              <div className="flex flex-wrap gap-2.5">
                {['Pipeline & Purchases First', 'LTV Maximization', 'No Vanity Metrics'].map(t => (
                  <span key={t} className="bg-white/15 text-white border-2 border-white/30 px-3.5 py-1.5 text-xs font-bold uppercase tracking-widest rounded">
                    {t}
                  </span>
                ))}
        ...
        {/* CONTACT */}
        <section id="contact" className="relative min-h-screen bg-[#FACC15] border-y-4 border-black flex flex-col items-center justify-center p-6 md:p-24 text-center overflow-hidden z-40">
            ...
            <div className="reveal relative z-10 max-w-4xl w-full mx-auto flex flex-col items-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="flex items-center gap-2 bg-white border-[3px] border-black px-4 py-2 rounded shadow-[3px_3px_0px_#000]">
                  <span className="text-lg">🔍</span>
                  <div className="text-left">
                    <div className="font-black text-xs uppercase tracking-widest text-black">Free Account Audit</div>
                    <div className="font-medium text-[10px] text-gray-500">We'll find what's leaking revenue</div>
                  </div>
                </div>
                <div className="flex items-center gap-2 bg-white border-[3px] border-black px-4 py-2 rounded shadow-[3px_3px_0px_#000]">
                  <span className="text-lg">⚡</span>
                  <div className="text-left">
                    <div className="font-black text-xs uppercase tracking-widest text-black">7-Day Trial Sprint</div>
                    <div className="font-medium text-[10px] text-gray-500">Results before you commit</div>
                  </div>
                </div>
              </div>

              <div className="flex flex-wrap justify-center gap-4 mb-6">
                <a href="https://calendly.com/helstandsouza/30min" target="_blank" className="btn-pulse bg-black text-white px-8 md:px-12 py-5 md:py-6 text-xl md:text-2xl font-black uppercase tracking-widest border-4 border-black rounded-md shadow-[8px_8px_0px_rgba(0,0,0,.25)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[12px_12px_0px_rgba(0,0,0,.25)] active:translate-x-2 active:translate-y-2 active:shadow-none transition-all inline-flex items-center gap-3">
                  Book A Strategy Call <ArrowUpRight size={22} strokeWidth={3} />
                </a>
                <a href="https://api.whatsapp.com/send?phone=919594729658&text=Hi%2C%20I%E2%80%99m%20looking%20to%20scale%20my%20business%20with%20performance%20marketing.%20Saw%20your%20portfolio%20and%20would%20love%20to%20connect!" target="_blank" className="bg-[#10B981] text-white px-8 md:px-10 py-5 md:py-6 text-xl md:text-2xl font-black uppercase tracking-widest border-4 border-black rounded-md shadow-[8px_8px_0px_rgba(0,0,0,.2)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[12px_12px_0px_rgba(0,0,0,.2)] active:translate-x-2 active:translate-y-2 active:shadow-none transition-all inline-flex items-center gap-3">
              ...
              <div className="relative w-full max-w-[280px]">
                ...
                <div className="bg-[#FACC15] border-4 border-black rounded-[120px_120px_8px_8px] shadow-[8px_8px_0px_#000] overflow-hidden">
                  <div className="w-full h-80 relative overflow-hidden bg-gray-300">
                    <img
                      src="https://ais-pre-vp3b242umjrkgejmwgfch5-107263749555.asia-east1.run.app/last_image.png"
                      alt="Helston D'Souza"
